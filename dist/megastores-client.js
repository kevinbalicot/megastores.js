...
},{"./transport":6,"./transports/index":7,"component-emitter":13,"debug":15,"engine.io-parser":18,"indexof":28,"parsejson":29,"parseqs":30,"parseuri":31}],6:[function(require,module,exports){
/**
 * Module dependencies.
 */
...
},{"./polling-jsonp":8,"./polling-xhr":9,"./websocket":11,"xmlhttprequest-ssl":12}],8:[function(require,module,exports){
(function (global){
...
},{"./polling":10,"component-emitter":13,"component-inherit":14,"debug":15,"xmlhttprequest-ssl":12}],10:[function(require,module,exports){
/**
 * Module dependencies.
 */
...
},{"../transport":6,"component-inherit":14,"debug":15,"engine.io-parser":18,"parseqs":30,"xmlhttprequest-ssl":12,"yeast":32}],11:[function(require,module,exports){
(function (global){
/**
 * Module dependencies.
 */
...
},{"../transport":6,"component-inherit":14,"debug":15,"engine.io-parser":18,"parseqs":30,"ws":1,"yeast":32}],12:[function(require,module,exports){
(function (global){
...
},{"./keys":19,"after":20,"arraybuffer.slice":21,"base64-arraybuffer":22,"blob":23,"has-binary":24,"wtf-8":26}],19:[function(require,module,exports){
...
},{"./createStore":37,"./utils/warning":39,"_process":2,"lodash/isPlainObject":49}],36:[function(require,module,exports){
"use strict";
...
},{"lodash/isPlainObject":49,"symbol-observable":50}],38:[function(require,module,exports){
(function (process){
'use strict';
...
},{"./applyMiddleware":33,"./bindActionCreators":34,"./combineReducers":35,"./compose":36,"./createStore":37,"./utils/warning":39,"_process":2}],39:[function(require,module,exports){
'use strict';
...
var Megastores = require('./megastores');
...
var Megastores = function (_BaseMegastores) {
    ...
    function Megastores() {
        ...
        var _this = _possibleConstructorReturn(this, (Megastores.__proto__ || Object.getPrototypeOf(Megastores)).call(this));
    ...
    _createClass(Megastores, [{
        ...
        value: function connect(url) {
            ...
            this.connection.on('open', function () {
                ...
                if (!!_this2.connecting) {
                    ...
                    _this2.connecting = null;
                    _this2.synchronize();
                }

                // Receive message from server, dispatch to store
                _this2.connection.on('message', function (message) {
                    var action = JSON.parse(message);
                    _this2.trigger('message', action);

                    if (!!action.event) {
                        _this2.trigger(action.event, action.data);
                    } else {
        ...
        key: 'dispatch',
        value: function dispatch(action, store) {
        ...
        value: function synchronize() {
            ...
            this.stores.forEach(function (store) {
                // Use store cache
                store.cache.forEach(function (action) {
                    return _this3.connection.send(JSON.stringify(action));
                });
            });
        }
...
},{"./../common/eventEmitter":57,"./../common/megastores":58,"engine.io-client":3}],55:[function(require,module,exports){
'use strict';
...
var Store = function (_BaseStore) {
    ...
    function Store(name) {
        ...
        var _this = _possibleConstructorReturn(this, (Store.__proto__ || Object.getPrototypeOf(Store)).call(this, name, intialState, options));

        _this.cache = [];
        // Enable caching items when connection with server lost
        _this.enableCache = options.enableCache || true;

        if (!!_this.options.offline) {
            _this.enableOfflineMode();
        }
        return _this;
    }
    ...
    _createClass(Store, [{
        ...
        value: function reducer() {
            ...
            switch (action.type) {
                ...
                case this.SYNCHRONIZE_ALL_ITEMS:
                    state = _get(Store.prototype.__proto__ || Object.getPrototypeOf(Store.prototype), 'createNewState', this).call(this, action.payload);
                    this.cache.forEach(function (cache) {
                        state = _get(Store.prototype.__proto__ || Object.getPrototypeOf(Store.prototype), 'reducer', _this2).call(_this2, state, cache);
                    });
                    this.clearCache();
                    break;
            }

            return _get(Store.prototype.__proto__ || Object.getPrototypeOf(Store.prototype), 'reducer', this).call(this, state, action);
        }
        ...
        value: function enableOfflineMode() {
            var _this3 = this;

            // merge initialState with local storage state
            var offlineState = JSON.parse(localStorage.getItem('state_' + this.name));
            if (!!offlineState) {
                this.intialState = this.merge(this.intialState, offlineState);
            }

            // Use middleware to update local storage state
            this.use(function (action, oldstate, newState, next) {
                localStorage.setItem('state_' + _this3.name, JSON.stringify(newState));
        ...
        value: function put(item) {
            ...
            _get(Store.prototype.__proto__ || Object.getPrototypeOf(Store.prototype), 'put', this).call(this, item);
        }
        ...
        key: 'update',
        value: function update(index, item) {
            // Cache action if there are no connection
            if (!this.options.offline && !this.store.connected && this.enableCache) {
                this.cache.push({ type: this.UPDATE_ITEM, payload: item, index: index });
            }

            _get(Store.prototype.__proto__ || Object.getPrototypeOf(Store.prototype), 'update', this).call(this, index, item);
        }
        ...
        value: function remove(index, item) {
            ...
            _get(Store.prototype.__proto__ || Object.getPrototypeOf(Store.prototype), 'remove', this).call(this, index, item);
        }
    }]);
        ...
        value: function trigger(event) {
            ...
            if (!!this.listeners[event]) {
                ...
                this.listeners[event].forEach(function (listener) {
                    listener.callback.call(listener.context || _this, data);
...
var _require = require('redux'),
    ...
    _createStore = _require.createStore,
...
var BaseMegastores = function (_EventEmitter) {
    ...
    function BaseMegastores() {
        ...
        var _this = _possibleConstructorReturn(this, (BaseMegastores.__proto__ || Object.getPrototypeOf(BaseMegastores)).call(this));
        ...
        _this.ERROR_INSTANTIATE = 'No store instantiated.';
        return _this;
    }
    ...
    _createClass(BaseMegastores, [{
        ...
        key: 'attach',
        value: function attach(store) {
            var _this2 = this;

            if (Array.isArray(store)) {
                store.forEach(function (store) {
                    _this2.stores.push(store);
                    // For each store, get reducer and inisital state
                    _this2.reducers[store.name] = store.reducer.bind(store);
                    _this2.intialState[store.name] = store.intialState;
                });
            } else {
        ...
        value: function createStore() {
            ...
            this.store = _createStore(combineReducers(this.reducers), this.intialState);
            this.stores.forEach(function (store) {
                return store.store = _this3;
            });
        }
    }]);
...
},{"./eventEmitter":57,"redux":38}],59:[function(require,module,exports){
'use strict';
...
var BaseStore = function () {
    ...
    _createClass(BaseStore, [{
        ...
        key: 'createNewState',
        value: function createNewState(state) {
        ...
        key: 'merge',
        value: function merge(state, item) {
            if (Array.isArray(state)) {
        ...
        key: 'delete',
        value: function _delete(state, index) {
            if (Array.isArray(state)) {
        ...
        key: 'dispatchMiddelwares',
        value: function dispatchMiddelwares(action, oldState, newState) {
        ...
        value: function use(callback) {
            this.middlewares.push({ callback: callback });
        }
